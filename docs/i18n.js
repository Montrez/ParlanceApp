const i18n = {
  ...
  _embedded: {
    en: {
      ...
      analyzeHint: "Write freely — paragraphs are fine. ⌘Enter / Ctrl+Enter for feedback.",
      ...
      dialectGuideDesc: "Regional vocabulary, pronouns, and words to know.",
      waitingText: "Write a paragraph in your practice language, then press <strong>⌘Enter</strong> / <strong>Ctrl+Enter</strong> (or Feedback).<br><br>Parlance splits it into sentences, infers CEFR level, and shows feedback here.",
    ...
    es: {
      ...
      analyzeHint: "Escribe con libertad — los párrafos están bien. ⌘Enter / Ctrl+Enter para feedback.",
      ...
      dialectGuideDesc: "Vocabulario regional, pronombres y palabras clave.",
      waitingText: "Escribe un párrafo en tu idioma de práctica y pulsa <strong>⌘Enter</strong> / <strong>Ctrl+Enter</strong> (o Feedback).<br><br>Parlance lo divide en oraciones, infiere el nivel MCER y muestra la retroalimentación aquí.",
    ...
    fr: {
      ...
      analyzeHint: "Écrivez librement — les paragraphes sont bienvenus. ⌘Entrée / Ctrl+Entrée pour le retour.",
      ...
      dialectGuideDesc: "Vocabulaire régional, pronoms et mots à connaître.",
      waitingText: "Écrivez un paragraphe dans votre langue de pratique, puis appuyez sur <strong>⌘Entrée</strong> / <strong>Ctrl+Entrée</strong> (ou Feedback).<br><br>Parlance le découpe en phrases, infère le niveau CECR et affiche le retour ici.",
