...
(function (root) {
  ...
  "principles": [
    ...
    "Do not rewrite politeness formulas that are already correct: «merci à vous», «s'il vous plaît», «cordialement».",
    "Est-il possible de + infinitive is correct. Do not invent a subjunctive error.",
    "«Le point négatif est que…» needs the copula. «Je me suis préparé et renseigné» uses a participle, not an infinitive.",
  ...
  "non_negotiable_errors": [
    ...
    "Missing copula: le point négatif que… → le point négatif est que…",
    "Infinitive after coordinated passé composé with être/se: et renseigner → et renseigné",
    "Do not «correct» merci à vous to merci vous; do not replace s'il vous plaît with an unrelated clause"
  ],
